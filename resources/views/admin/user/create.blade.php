                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h4 class="mb-3 text-primary">
                            <i class="bi bi-person-lines-fill me-2"></i> Formulir Pendaftaran User Baru
                        </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="name" placeholder="Contoh: Lexi Yamana" value="{{ old('name') }}"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="email" placeholder="Contoh: lexi@gmail.com" value="{{ old('email') }}"
                                        required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
