...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-sm bg-white p-6 rounded-lg shadow-lg">
        <h1 class="text-2xl font-bold text-center text-gray-800 mb-6">Login UMKM</h1>
        ...
        <form action="{{ url('/login') }}" method="POST" class="space-y-5">
            ...
            <button type="submit"
                class="w-full py-2 px-4 bg-blue-900 text-white rounded-md hover:bg-blue-900 transition">
                MASUK
            </button>
        </form>
    </div>
